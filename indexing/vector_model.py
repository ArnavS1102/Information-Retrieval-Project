# vector_space_model.py (incremental indexing version)
...
class VectorSpaceModel:
    def __init__(self, data_path, cache_dir="tfidf_cache"):
        ...
        self.doc_hashes = {}  # Stores hash(url+text) for change detection
    ...
    def preprocess_and_vectorize(self):
        ...
        if new_texts:
            ...
            self.tfidf_matrix = updated_matrix  # You can extend the matrix with old entries if needed
